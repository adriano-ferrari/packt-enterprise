...
urlpatterns = [
    ...
    path('my_wanted_url/', TemplateView.as_view(template_name='chapter_4/index.html')),
    ...
    #path('my_year_path/<year:year>/', TemplateView.as_view(template_name='chapter_4/index.html')),
